...
class CardOnFileRepositoryImp : CardOnFileRepository {
  ...
  private val _paymentMethods = MutableValue(listOf(
    PaymentMethodEntity(id ="0",name ="우리은행", digits= "0123", color = "#ff9a38ff", isPrimary = false),
    PaymentMethodEntity(id ="1",name ="신한은행", digits= "0223", color = "#f178f6ff", isPrimary = false),
    PaymentMethodEntity(id ="2",name ="국민은행", digits= "0323", color = "#f1c5f5ff", isPrimary = false),
    PaymentMethodEntity(id ="3",name ="삼성은행", digits= "0423", color = "#f1c466ff", isPrimary = false),
    PaymentMethodEntity(id ="4",name ="현대은행", digits= "0623", color = "#f1cc00ff", isPrimary = false),
  ))
